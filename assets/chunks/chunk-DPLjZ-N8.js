...
void main() {
	...
	`}var La=class extends Bt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new ti([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
      ...
      `,fragmentShader:`
        ...
        void main() {
          ...
          // Flip x-coordinate to mirror the scene horizontally (streaks come from the right)
          vec2 flippedCoord = vec2(iResolution.x - gl_FragCoord.x, gl_FragCoord.y);
          vec2 p = ((flippedCoord + shake * iResolution.xy) - iResolution.xy * 0.5) / iResolution.y * mat2(6.0, -4.0, 4.0, 6.0);
          vec2 v;
          vec4 o = vec4(0.0);
          ...
          // Blend with site background color #0B0F2A
          vec3 bgColor = vec3(0.043, 0.059, 0.165);
          vec3 finalColor = bgColor + o.rgb * 1.5;
          gl_FragColor = vec4(finalColor, 1.0);
        }
      `}),c=new oi(2,2),l=new Ur(c,s);n.add(l);let u,d=()=>{s.uniforms.iTime.value+=.016,i.render(n,r),u=requestAnimationFrame(d)};d();let f=()=>{let e=t.clientWidth,n=t.clientHeight;i.setSize(e,n),s.uniforms.iResolution.value.set(e,n)};return window.addEventListener(`resize`,f),()=>{cancelAnimationFrame(u),window.removeEventListener(`resize`,f),t.contains(i.domElement)&&t.removeChild(i.domElement),c.dispose(),s.dispose(),i.dispose()}},[]),(0,$.jsxs)(`div`,{className:`absolute inset-0 overflow-hidden pointer-events-none`,children:[(0,$.jsx)(`div`,{ref:e,className:`absolute top-0 right-0 bottom-0 w-[65%] overflow-hidden`}),(0,$.jsx)(`div`,{className:`absolute top-0 bottom-0 right-[45%] w-[25%] pointer-events-none`,style:{background:`linear-gradient(to right, #0B0F2A, transparent)`}})]})},Cc={hidden:{opacity:0,y:40},visible:{opacity:1,y:0}},wc=({children:e,className:t=``,delay:n=0})=>(0,$.jsx)(r.div,{className:t,initial:`hidden`,whileInView:`visible`,viewport:{once:!0,margin:`-80px`},variants:Cc,transition:{duration:.7,delay:n*.12,ease:[.25,.46,.45,.94]},children:e}),Tc=[{icon:`architecture`,title:`Landing Zone Architecture & Deployment`,description:`Full conceptual and logical design aligned to the Microsoft Cloud Adoption Framework - then delivered directly into your tenant.`},{icon:`account_tree`,title:`Management Group & Azure Policy Design`,description:`Management Group hierarchy and custom Azure Policy implementation to enforce compliance, cost control, and standards automatically.`},{icon:`fingerprint`,title:`Identity & Access (RBAC, Entra ID)`,description:`Granular access control structures and managed identity strategies to secure every interaction within your tenant.`},{icon:`hub`,title:`Network Architecture`,description:`Hub & Spoke topologies with Azure Firewall, WAF, and private link integration for hardened perimeter security and private connectivity.`},{icon:`code`,title:`Infrastructure as Code (Bicep / Terraform)`,description:`Automated provisioning using Bicep or Terraform to ensure environment consistency, repeatability, and rapid disaster recovery.`},{icon:`shield_with_heart`,title:`Secure Environment Configuration`,description:`Hardened baseline configurations for storage, compute, and databases, aligned to best practices and the principle of least privilege.`}],Ec=[{icon:`rocket_launch`,title:`New Azure Environment Setup`,description:`Build a secure, scalable foundation from day one using proven architecture and best practices.`,image:`https://lh3.googleusercontent.com/aida-public/AB6AXuDZxmh_rwb9QhWuywZCNFQhonAJMyxc6ClzVLwWqvjcTUD9_gIRxCSKJvWJoIBGHbUZd17CFwwQ-xNDy2gK1VGD5q4r2TQ6CY_LHO4xA8mh5HnkXTruWr3aEOEIhS4WtNSDGgb-1e7jbQ54Je0jrB0cAjHgHK29PxuYCQ2rGlEqWmnXpZYB5f65ok-RoizBmEnTq_6ZZVMqrFXSXCUGpUMwyZQJjSwAhH49kzC91Q7udF5M5HTRNE4_fSSA9AMNU-BoyHlOdUlIR8eR`},{icon:`cleaning_services`,title:`Tenant Restructuring & Clean-up`,description:`Redesign poorly structured environments to improve governance, security, and manageability.`,image:`https://lh3.googleusercontent.com/aida-public/AB6AXuAUmVss6YhmHAeZTnY9tgdGjeKObuOdVoKo-eu1QZIw5FbIQCVJha8iAXCpXQhJweMLYRa8CKfmHNDePS_F5f_9H0LxkQ4KCcL7wl2Hy4OtlD1CeEugzv2Pz5E6Oiqyp3WMyo8DdKxLtHdbUEcbKP14Ej8fFJDMXvZxgamz3gSd1wjKrhRjaQkWM4KJ5vfFLvgz-r86xEFicXr04J487MCjN62PsnWKF1RAWXJ14h0t4AaxSf459xLuFgL5rPesoBHCbHuBgnwZIHZB`},{icon:`corporate_fare`,title:`Enterprise Cloud Adoption`,description:`Establish a consistent, repeatable foundation to support large-scale or multi-team deployments.`,image:`https://lh3.googleusercontent.com/aida-public/AB6AXuDWzsJEMY_tMcgRhpvoarbT9ZfhbqkqebbUDnmpE371QHTZmkkGB__IWNHj3zqfeqmKKSbnnc36FuNcecAdgQiuWumA3HmpgRwwJRY7phbJjIFbwxmn_0J5e_ihoCpkpsGljpa2Xd09Jlc_DyTp1F_uuUQjbuLJpqZ4_xpIX9mE8y1zawdn46RxPbQC_T5KOCU17haH7VcKtpPJ1uJflQVKmBBO_nUfnKMBHSEkJxVeNMD_-H2eshnYtyHaYvYIaOGA2EYw8QLU55PE`},{icon:`policy`,title:`Governance & Policy Implementation`,description:`Enforce standards across subscriptions using Management Groups and Azure Policy.`,image:`https://lh3.googleusercontent.com/aida-public/AB6AXuC9aJE50M4p_v6TJWwWcSO4XXdUGSVLYItrVOZmSZROMedYuds3m3p1yxy7kaPx0O1nUa8JQOOyqHFu0wyBbC_V4QYselKmQ-z7gW4IOKL7Lydi07tVrtwLgLfUAmFNZ0GLQp8VAcG4rP1IyHNCYe9RGl2H1uB9ErLz4GSy_dwt0JFePRBoKlQczmSbDMYBlBu5xY-LfOZoV_kbzqC-84mFnWyEAztXy6dJ_uF_fQxcBCGwHbxtVJawIA1HMweVBrRHPjQN4TXh-zVH`},{icon:`lan`,title:`Secure Network Architecture Design`,description:`Implement Hub & Spoke and private connectivity to reduce exposure and improve control.`,image:`https://lh3.googleusercontent.com/aida-public/AB6AXuCf8Bhdy6VVOSUT4dTau2cVPcPlmS3Hnw0KM3zWMHQFG6TsxbGVGb0yTDQ6Sc-MD23UA_w2-m45KUZgA_2yzsFNBwlgM2x-B8Cz66cZtIdeneOfSDQ2Sdbz26IPY8-hi76_cEy6pAvybUrfUBZwC8uQk6rPAPE1Qc7v4nIpZi6yw5JVQVIq_QGOr9ZNXHSiaI705-Xn82pHZcw33pEJRcYrss4HYiX6nm0JKEjHCaGuuNSdusvgvTvTTQKTAO1rFTStRslymp1tTOST`},{icon:`terminal`,title:`Infrastructure as Code Adoption`,description:`Move from manual deployments to automated, consistent infrastructure provisioning.`,image:`https://lh3.googleusercontent.com/aida-public/AB6AXuAKTafSUmVnKw5KVoye-4KYVStxoL0idGrcSauvf5YYg5NQai-tNd3bCEL7Vpt5dzu9j3OK3ejr0xj9eEkewZTrD9UuuzzedfUfgHtq-b_Ugcc6Dnr8b193M0OUfnSFf1OoOBj4RB02s66TYtwgWupnq4Xsyaf75itp0H4Shu1DFzsJbflUVTCo_tKhch0LubuS3lHb0jxTm_viftP3n1iTedvg8BLTkcrY3fYz7semjcF2gn5JoP_WbTFQJvz9CLEOVO6OTDjcX-d1`}],Dc=[{icon:`trending_up`,title:`Faster Time to Market`,description:`Provision new environments in minutes, not weeks.`},{icon:`verified_user`,title:`Compliant by Design`,description:`Governance is baked into the foundation, ensuring continuous compliance.`},{icon:`payments`,title:`Predictable Costs`,description:`Tagging and budget policies prevent cloud spend from spiralling out of control.`}],Oc=({className:e=``})=>(0,$.jsxs)(`main`,{className:`pt-24 ${e}`,children:[(0,$.jsx)(a,{...c.azureLandingZones,schema:[s({name:`Azure Landing Zones`,description:c.azureLandingZones.description,path:c.azureLandingZones.path,serviceType:`Cloud Platform Architecture`}),u([{name:`Home`,path:`/`},{name:`Azure Landing Zones`,path:c.azureLandingZones.path}]),l(d.azureLandingZones)]}),(0,$.jsxs)(`section`,{className:`relative pt-28 pb-36 flex items-center px-8 md:px-24 overflow-hidden bg-background`,children:[(0,$.jsx)(Sc,{}),(0,$.jsx)(r.div,{className:`absolute top-[-10%] right-[-5%] w-[700px] h-[700px] rounded-full pointer-events-none`,style:{background:`radial-gradient(circle, rgba(160,0,181,0.18) 0%, transparent 70%)`},animate:{scale:[1,1.15,1],opacity:[.6,1,.6]},transition:{duration:8,repeat:1/0,ease:`easeInOut`}}),(0,$.jsx)(r.div,{className:`absolute bottom-[-10%] left-[15%] w-[500px] h-[500px] rounded-full pointer-events-none`,style:{background:`radial-gradient(circle, rgba(217,70,239,0.10) 0%, transparent 70%)`},animate:{scale:[1,1.2,1],opacity:[.4,.8,.4]},transition:{duration:10,repeat:1/0,ease:`easeInOut`,delay:3}}),(0,$.jsx)(`div`,{className:`absolute inset-0 pointer-events-none opacity-[0.03]`,style:{backgroundImage:`linear-gradient(rgba(160,0,181,1) 1px, transparent 1px), linear-gradient(90deg, rgba(160,0,181,1) 1px, transparent 1px)`,backgroundSize:`80px 80px`}}),(0,$.jsx)(`div`,{className:`relative z-10 max-w-[1440px] mx-auto w-full`,children:(0,$.jsxs)(`div`,{className:`max-w-4xl`,children:[(0,$.jsxs)(r.div,{className:`flex items-center gap-3 mb-8`,initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6,delay:.2},children:[(0,$.jsx)(`div`,{className:`w-8 h-px bg-primary`}),(0,$.jsx)(`span`,{className:`text-[10px] uppercase tracking-[0.4em] text-primary font-bold font-label`,children:`Azure Infrastructure`})]}),(0,$.jsxs)(`h1`,{className:`font-headline text-[3.5rem] md:text-[5.5rem] leading-[1.0] font-extrabold tracking-tighter mb-8`,children:[(0,$.jsx)(r.span,{className:`block`,initial:{opacity:0,y:60},animate:{opacity:1,y:0},transition:{duration:.7,delay:.3,ease:[.25,.46,.45,.94]},children:`Azure Foundation &`}),(0,$.jsx)(r.span,{className:`block text-gradient-primary`,initial:{opacity:0,y:60},animate:{opacity:1,y:0},transition:{duration:.7,delay:.44,ease:[.25,.46,.45,.94]},children:`Landing Zones`})]}),(0,$.jsx)(r.p,{className:`text-xl md:text-2xl text-on-surface-variant font-light leading-relaxed max-w-2xl mb-12 border-l-2 border-primary/20 pl-6`,initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.7,delay:.62},children:`Build a secure, scalable Azure environment designed for long-term growth. Every deployment built with security, governance, and scalability at its core.`})]})}),(0,$.jsxs)(r.div,{className:`absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 z-10`,initial:{opacity:0},animate:{opacity:1},transition:{delay:1.4,duration:.6},children:[(0,$.jsx)(`span`,{className:`text-[10px] uppercase tracking-widest text-on-surface-variant/50 font-label`,children:`Scroll`}),(0,$.jsx)(r.div,{className:`w-px h-10 bg-gradient-to-b from-primary/60 to-transparent`,animate:{scaleY:[1,.4,1],opacity:[.6,.2,.6]},transition:{duration:2,repeat:1/0,ease:`easeInOut`}})]})]}),(0,$.jsx)(`section`,{className:`py-32 px-8 md:px-24 bg-surface border-t border-outline`,children:(0,$.jsxs)(`div`,{className:`max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-24 items-center`,children:[(0,$.jsxs)(`div`,{className:`space-y-8`,children:[(0,$.jsxs)(wc,{children:[(0,$.jsx)(`span`,{className:`text-[10px] uppercase tracking-[0.3em] text-primary font-bold font-label block mb-4`,children:`Overview`}),(0,$.jsxs)(`h2`,{className:`font-headline text-4xl md:text-5xl font-bold tracking-tight`,children:[`A Structured Foundation for`,` `,(0,$.jsx)(`span`,{className:`text-gradient-primary`,children:`Long-Term Growth`})]})]}),(0,$.jsx)(wc,{delay:1,children:(0,$.jsx)(`p`,{className:`text-lg text-on-surface-variant leading-relaxed`,children:`We design and implement Azure landing zones that provide a strong, structured foundation for your cloud environment. Every deployment is built with security, governance, and scalability at its core, ensuring your platform can grow without introducing risk or complexity.`})})]}),(0,$.jsx)(wc,{delay:2,children:(0,$.jsxs)(`div`,{className:`relative`,children:[(0,$.jsx)(`div`,{className:`absolute -inset-6 bg-primary/5 rounded-3xl blur-3xl pointer-events-none`}),(0,$.jsx)(`div`,{className:`relative bg-surface-container-highest p-4 rounded-2xl shadow-2xl border border-outline/30`,children:(0,$.jsx)(`img`,{src:`https://lh3.googleusercontent.com/aida-public/AB6AXuBMH1Y5v6DgUES11qEouC-M_nD9L-9CKIN9Uzje8KET6pOqgLn_52J_eVubzls1ALVJQmPCoVaI1lpk-E4ED6U-wWuvGjk_OcHtwOXJDa9t9OrhjjBQdVcOElizwlSfBUT1hg2ouhPpJwDKeVjfCVd7sXyhytMZJ32KzQPOuuU8HKW0m3gNrv1P_ty3JX3NZ-5vVz1vvLUoyCsMm-h0HtHY40bWw33nxG8FvTAByirXawHnlssX7RYheH2APGB41L3yVhKLXDQLpMGn`,alt:`Azure architecture overview`,className:`rounded-xl w-full h-[460px] object-cover`})})]})})]})}),(0,$.jsx)(`section`,{className:`py-32 px-8 md:px-24 bg-background`,children:(0,$.jsxs)(`div`,{className:`max-w-[1440px] mx-auto`,children:[(0,$.jsxs)(wc,{className:`mb-20`,children:[(0,$.jsx)(`span`,{className:`text-[10px] uppercase tracking-[0.3em] text-primary font-bold font-label block mb-4`,children:`Deliverables`}),(0,$.jsx)(`h2`,{className:`font-headline text-4xl md:text-5xl font-bold tracking-tight max-w-2xl`,children:`What We Deliver`}),(0,$.jsx)(`div`,{className:`h-px w-24 bg-gradient-to-r from-primary to-transparent mt-6`})]}),(0,$.jsx)(`div`,{className:`grid grid-cols-1 md:grid-cols-3 gap-6`,children:Tc.map(({icon:e,title:t,description:n},i)=>(0,$.jsx)(r.div,{initial:`hidden`,whileInView:`visible`,viewport:{once:!0,margin:`-60px`},variants:Cc,transition:{duration:.6,delay:i*.1,ease:[.25,.46,.45,.94]},children:(0,$.jsxs)(f,{className:`group h-full bg-surface border border-outline/60 rounded-2xl p-8 hover:border-primary/30 transition-all relative overflow-hidden`,children:[(0,$.jsx)(`div`,{className:`absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary/60 to-transparent`}),(0,$.jsx)(`div`,{className:`absolute top-0 right-0 w-48 h-48 bg-primary/5 rounded-full blur-[60px] opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none`}),(0,$.jsxs)(`div`,{className:`relative z-10`,children:[(0,$.jsx)(`div`,{className:`w-12 h-12 rounded-xl bg-primary/10 border border-primary/25 flex items-center justify-center mb-6 group-hover:bg-primary/20 transition-colors`,children:(0,$.jsx)(`span`,{"aria-hidden":`true`,className:`material-symbols-outlined text-primary`,style:{fontSize:`1.4rem`},children:e})}),(0,$.jsx)(`h4`,{className:`font-headline text-lg font-bold mb-3`,children:t}),(0,$.jsx)(`p`,{className:`text-on-surface-variant text-sm leading-relaxed`,children:n})]})]})},t))})]})}),(0,$.jsx)(`section`,{className:`py-32 bg-surface border-t border-outline`,children:(0,$.jsx)(`div`,{className:`max-w-[1440px] mx-auto px-8 md:px-24`,children:(0,$.jsxs)(`div`,{className:`flex flex-col md:flex-row gap-20 items-center`,children:[(0,$.jsx)(wc,{className:`w-full md:w-1/2`,children:(0,$.jsxs)(`div`,{className:`relative`,children:[(0,$.jsx)(`div`,{className:`absolute -top-8 -left-8 w-64 h-64 bg-primary/10 rounded-full blur-3xl pointer-events-none`}),(0,$.jsx)(`div`,{className:`relative bg-surface-container-highest p-4 rounded-2xl shadow-2xl border border-outline/30`,children:(0,$.jsx)(`img`,{src:`https://lh3.googleusercontent.com/aida-public/AB6AXuCf8Bhdy6VVOSUT4dTau2cVPcPlmS3Hnw0KM3zWMHQFG6TsxbGVGb0yTDQ6Sc-MD23UA_w2-m45KUZgA_2yzsFNBwlgM2x-B8Cz66cZtIdeneOfSDQ2Sdbz26IPY8-hi76_cEy6pAvybUrfUBZwC8uQk6rPAPE1Qc7v4nIpZi6yw5JVQVIq_QGOr9ZNXHSiaI705-Xn82pHZcw33pEJRcYrss4HYiX6nm0JKEjHCaGuuNSdusvgvTvTTQKTAO1rFTStRslymp1tTOST`,alt:`Azure landing zone business impact and governance illustration`,className:`rounded-xl w-full h-[500px] object-cover`})})]})}),(0,$.jsxs)(`div`,{className:`w-full md:w-1/2 space-y-8`,children:[(0,$.jsxs)(wc,{children:[(0,$.jsx)(`span`,{className:`text-[10px] uppercase tracking-[0.3em] text-primary font-bold font-label block mb-4`,children:`Business Impact`}),(0,$.jsxs)(`h2`,{className:`font-headline text-4xl md:text-5xl font-extrabold tracking-tighter`,children:[`Scale with`,` `,(0,$.jsx)(`span`,{className:`text-gradient-primary`,children:`Confidence`})]})]}),(0,$.jsx)(wc,{delay:1,children:(0,$.jsx)(`p`,{className:`text-lg text-on-surface-variant leading-relaxed`,children:`Many Azure environments are built quickly without proper structure, leading to security gaps, inconsistent deployments, and operational complexity.`})}),(0,$.jsx)(wc,{delay:2,children:(0,$.jsx)(`p`,{className:`text-lg text-on-surface-variant leading-relaxed`,children:`We establish a clear, well-architected foundation that enables your organisation to scale confidently. By embedding governance, security, and automation from the outset, your cloud environment remains controlled, efficient, and aligned with best practices as it grows.`})}),(0,$.jsx)(`div`,{className:`space-y-4 pt-2`,children:Dc.map(({icon:e,title:t,description:n},r)=>(0,$.jsx)(wc,{delay:3+r,children:(0,$.jsxs)(`div`,{className:`flex items-start gap-4 p-5 bg-surface-container rounded-xl border border-outline/30 hover:border-primary/30 transition-colors group`,children:[(0,$.jsx)(`div`,{className:`bg-primary/15 p-2.5 rounded-lg text-primary shrink-0 group-hover:bg-primary/25 transition-colors`,children:(0,$.jsx)(`span`,{"aria-hidden":`true`,className:`material-symbols-outlined`,style:{fontSize:`1.2rem`},children:e})}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`h5`,{className:`font-headline font-bold mb-1`,children:t}),(0,$.jsx)(`p`,{className:`text-on-surface-variant text-sm`,children:n})]})]})},t))})]})]})})}),(0,$.jsx)(`section`,{className:`py-32 px-8 md:px-24 bg-background`,children:(0,$.jsxs)(`div`,{className:`max-w-[1440px] mx-auto`,children:[(0,$.jsxs)(wc,{className:`text-center mb-20 space-y-4`,children:[(0,$.jsx)(`span`,{className:`text-[10px] uppercase tracking-[0.3em] text-primary font-bold font-label block`,children:`Application`}),(0,$.jsx)(`h2`,{className:`font-headline text-4xl md:text-5xl font-bold tracking-tight`,children:`Common Use Cases`}),(0,$.jsx)(`p`,{className:`text-on-surface-variant max-w-xl mx-auto`,children:`Strategic triggers for Azure foundation modernisation.`})]}),(0,$.jsx)(`div`,{className:`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6`,children:Ec.map(({icon:e,title:t,description:n,image:i},a)=>(0,$.jsxs)(r.div,{initial:`hidden`,whileInView:`visible`,viewport:{once:!0,margin:`-60px`},variants:Cc,transition:{duration:.6,delay:a*.1,ease:[.25,.46,.45,.94]},className:`group relative h-[320px] rounded-2xl overflow-hidden cursor-pointer`,children:[(0,$.jsx)(`img`,{src:i,alt:t,className:`absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105`}),(0,$.jsx)(`div`,{className:`absolute inset-0 bg-gradient-to-t from-background via-background/55 to-transparent`}),(0,$.jsx)(`div`,{className:`absolute inset-0 bg-primary/0 group-hover:bg-primary/10 transition-colors duration-500`}),(0,$.jsx)(`div`,{className:`absolute inset-0 rounded-2xl border border-outline/20 group-hover:border-primary/40 transition-colors duration-500`}),(0,$.jsx)(`div`,{className:`absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary/0 group-hover:via-primary/60 to-transparent transition-all duration-500`}),(0,$.jsxs)(`div`,{className:`absolute inset-0 flex flex-col justify-end p-8 z-10`,children:[(0,$.jsxs)(`div`,{className:`flex items-center gap-3 mb-3`,children:[(0,$.jsx)(`div`,{className:`w-8 h-8 rounded-lg bg-primary/20 border border-primary/30 flex items-center justify-center shrink-0 group-hover:bg-primary/40 transition-colors`,children:(0,$.jsx)(`span`,{"aria-hidden":`true`,className:`material-symbols-outlined text-primary`,style:{fontSize:`1rem`},children:e})}),(0,$.jsx)(`h4`,{className:`font-headline text-lg font-bold`,children:t})]}),(0,$.jsx)(`div`,{className:`overflow-hidden transition-all duration-500 max-h-0 group-hover:max-h-20`,children:(0,$.jsx)(`p`,{className:`text-sm text-on-surface-variant leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100`,children:n})})]})]},t))})]})}),(0,$.jsx)(o,{items:d.azureLandingZones,groupName:`faq-azure-landing-zones`,eyebrow:`Questions`,heading:`Frequently asked questions`,description:`What clients ask us most often about Azure landing zones and platform foundations.`}),(0,$.jsxs)(`section`,{className:`py-44 bg-surface relative overflow-hidden border-t border-outline`,children:[(0,$.jsx)(r.div,{className:`absolute top-0 right-0 w-[500px] h-[500px] rounded-full blur-[140px] pointer-events-none`,style:{background:`rgba(160, 0, 181, 0.12)`},animate:{scale:[1,1.2,1],opacity:[.6,1,.6]},transition:{duration:6,repeat:1/0,ease:`easeInOut`}}),(0,$.jsx)(r.div,{className:`absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full blur-[120px] pointer-events-none`,style:{background:`rgba(217, 70, 239, 0.08)`},animate:{scale:[1,1.3,1],opacity:[.4,.8,.4]},transition:{duration:8,repeat:1/0,ease:`easeInOut`,delay:2}}),(0,$.jsxs)(`div`,{className:`max-w-[1440px] mx-auto px-8 relative z-10 text-center`,children:[(0,$.jsx)(wc,{children:(0,$.jsxs)(`h2`,{className:`font-headline text-5xl md:text-7xl font-extrabold tracking-tighter mb-12`,children:[`READY TO BUILD YOUR`,(0,$.jsx)(`br`,{}),(0,$.jsx)(`span`,{className:`text-gradient-primary`,children:`AZURE FOUNDATION?`})]})}),(0,$.jsx)(wc,{delay:1,children:(0,$.jsx)(`p`,{className:`text-on-surface-variant text-lg max-w-xl mx-auto mb-16 leading-relaxed`,children:`Schedule a consultation with our cloud architects to discuss your landing zone strategy.`})}),(0,$.jsx)(wc,{delay:2,children:(0,$.jsxs)(`div`,{className:`flex flex-col md:flex-row justify-center items-center gap-6`,children:[(0,$.jsx)(i,{to:`/contact`,className:`no-underline`,children:(0,$.jsx)(r.button,{className:`btn-animated text-white font-headline font-bold px-14 py-6 rounded-lg text-xl tracking-tight`,whileHover:{scale:1.03},whileTap:{scale:.97},children:`Book a Consultation`})}),(0,$.jsx)(i,{to:`/how-we-work`,className:`no-underline`,children:(0,$.jsx)(r.button,{className:`border border-outline/50 hover:border-primary/40 text-on-surface font-headline font-bold px-14 py-6 rounded-lg text-xl tracking-tight transition-colors`,whileHover:{scale:1.03},whileTap:{scale:.97},children:`View Our Process`})})]})})]})]}),(0,$.jsxs)(`div`,{className:`max-w-[1440px] mx-auto px-8 pb-10 text-center text-[11px] uppercase tracking-[0.2em] text-on-surface-variant/50 font-label`,children:[`Further reading:`,` `,(0,$.jsx)(`a`,{href:`https://learn.microsoft.com/azure/cloud-adoption-framework/ready/landing-zone/`,target:`_blank`,rel:`noopener noreferrer`,className:`hover:text-primary transition-colors underline-offset-4 hover:underline`,children:`Microsoft CAF Landing Zones`}),` · `,(0,$.jsx)(`a`,{href:`https://learn.microsoft.com/azure/governance/management-groups/overview`,target:`_blank`,rel:`noopener noreferrer`,className:`hover:text-primary transition-colors underline-offset-4 hover:underline`,children:`Azure Management Groups`})]})]});export{Oc as AzureLandingZonesPage,Oc as default};